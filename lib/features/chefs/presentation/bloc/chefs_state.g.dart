...
class _$ChefsState extends ChefsState {
  ...
  _$ChefsState._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        isNearestLoading, r'ChefsState', 'isNearestLoading');
    BuiltValueNullFieldError.checkNotNull(nearest, r'ChefsState', 'nearest');
    BuiltValueNullFieldError.checkNotNull(
        isTopRatedLoading, r'ChefsState', 'isTopRatedLoading');
    BuiltValueNullFieldError.checkNotNull(topRated, r'ChefsState', 'topRated');
    BuiltValueNullFieldError.checkNotNull(
        isTopOrderedLoading, r'ChefsState', 'isTopOrderedLoading');
    BuiltValueNullFieldError.checkNotNull(
        topOrdered, r'ChefsState', 'topOrdered');
    BuiltValueNullFieldError.checkNotNull(
        isMostRecentLoading, r'ChefsState', 'isMostRecentLoading');
    BuiltValueNullFieldError.checkNotNull(
        mostRecent, r'ChefsState', 'mostRecent');
    BuiltValueNullFieldError.checkNotNull(
        isLoading, r'ChefsState', 'isLoading');
    BuiltValueNullFieldError.checkNotNull(error, r'ChefsState', 'error');
    BuiltValueNullFieldError.checkNotNull(message, r'ChefsState', 'message');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ChefsState')
    ...
    final _$result = _$v ??
        new _$ChefsState._(
            ...
            mostRecent: BuiltValueNullFieldError.checkNotNull(
                mostRecent, r'ChefsState', 'mostRecent'),
            isLoading: BuiltValueNullFieldError.checkNotNull(isLoading, r'ChefsState', 'isLoading'),
            error: BuiltValueNullFieldError.checkNotNull(error, r'ChefsState', 'error'),
            message: BuiltValueNullFieldError.checkNotNull(message, r'ChefsState', 'message'));
    replace(_$result);
    return _$result;
  }
}
