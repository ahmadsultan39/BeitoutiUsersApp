...
import 'core/data/base_repository.dart' as _i37;
...
import 'features/auth/data/data_source/remote/auth_remote_data_source_imp.dart'
    as _i33;
import 'features/auth/data/repository/auth_repository_imp.dart' as _i35;
import 'features/auth/domain/repository/auth_repository.dart' as _i34;
import 'features/auth/domain/use_cases/check_code_use_case.dart' as _i44;
...
import 'features/cart/data/data_sources/remote/cart_remote_data_source_imp.dart'
    as _i41;
import 'features/cart/data/repositories/cart_repository_imp.dart' as _i43;
import 'features/cart/domain/repositories/cart_repository.dart' as _i42;
import 'features/cart/domain/use_cases/delete_cart_item_use_case.dart' as _i63;
import 'features/cart/domain/use_cases/delete_cart_use_case.dart' as _i64;
...
import 'features/chefs/data/data_sources/remote/chefs_remote_data_source_imp.dart'
    as _i54;
import 'features/chefs/data/repositories/chefs_repository_imp.dart' as _i56;
import 'features/chefs/domain/repositories/chefs_repository.dart' as _i55;
...
import 'features/meal/domain/use_cases/remove_from_favourite_use_case.dart'
    as _i103;
import 'features/meal/presentation/bloc/meal_bloc.dart' as _i145;
...
import 'features/meals/domain/use_cases/get_top_subscriptions_meals_use_case.dart'
    as _i143;
import 'features/meals/presentation/bloc/meals_bloc.dart' as _i146;
...
import 'features/order/presentation/bloc/order_bloc.dart' as _i147;
...
import 'features/orders/domain/use_cases/get_previous_orders_use_case.dart'
    as _i136;
import 'features/orders/presentation/bloc/orders_bloc.dart' as _i148;
...
import 'features/profile/domain/use_cases/get_profile_info_use_case.dart'
    as _i137;
import 'features/profile/domain/use_cases/logout_use_case.dart' as _i144;
import 'features/profile/presentation/bloc/profile_bloc.dart' as _i149;
...
import 'features/search/domain/use_cases/search_chefs.dart' as _i150;
import 'features/search/domain/use_cases/search_meals.dart' as _i151;
...
import 'features/splash/presentation/bloc/splash_bloc.dart' as _i152;
...
import 'features/subscription/presentation/bloc/subscription_bloc.dart'
    as _i154;
import 'injection.dart' as _i156; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i17.ProfileRemoteDataSource>(
      () => _i18.ProfileRemoteDataSourceImp(dio: get<_i4.Dio>()));
  gh.lazySingleton<_i19.SearchRemoteDataSource>(
      () => _i20.SearchRemoteDataSourceImp(dio: get<_i4.Dio>()));
  ...
  gh.lazySingleton<_i26.SubscriptionLocalDataSource>(() =>
      _i27.SubscriptionLocalDataSourceImp(
          sharedPreferences: get<_i21.SharedPreferences>()));
  gh.lazySingleton<_i28.SubscriptionRemoteDataSource>(
      () => _i29.SubscriptionRemoteDataSourceImp(dio: get<_i4.Dio>()));
  gh.lazySingleton<_i30.AuthLocalDataSource>(() => _i31.AuthLocalDataSourceImp(
      sharedPreferences: get<_i21.SharedPreferences>()));
  gh.lazySingleton<_i32.AuthRemoteDataSource>(
      () => _i33.AuthRemoteDataSourceImp(dio: get<_i4.Dio>()));
  gh.lazySingleton<_i34.AuthRepository>(() => _i35.AuthRepositoryImp(
      get<_i30.AuthLocalDataSource>(), get<_i32.AuthRemoteDataSource>()));
  gh.lazySingleton<_i36.BaseLocalDataSource>(() => _i36.BaseLocalDataSourceImpl(
      sharedPreferences: get<_i21.SharedPreferences>()));
  gh.lazySingleton<_i37.BaseRepository>(() => _i37.BaseRepositoryImpl(
      baseLocalDataSource: get<_i36.BaseLocalDataSource>(),
      networkInfo: get<_i12.NetworkInfo>()));
  gh.lazySingleton<_i38.CartLocalDataSource>(() => _i39.CartLocalDataSourceImp(
      sharedPreferences: get<_i21.SharedPreferences>(),
      cartDataBaseManager: get<_i3.CartDataBaseManager>()));
  gh.lazySingleton<_i40.CartRemoteDataSource>(
      () => _i41.CartRemoteDataSourceImp(dio: get<_i4.Dio>()));
  gh.lazySingleton<_i42.CartRepository>(() => _i43.CartRepositoryImp(
      get<_i40.CartRemoteDataSource>(), get<_i38.CartLocalDataSource>(),
      networkInfo: get<_i12.NetworkInfo>()));
  gh.lazySingleton<_i44.CheckCodeUseCase>(
      () => _i44.CheckCodeUseCase(get<_i34.AuthRepository>()));
  gh.lazySingleton<_i45.ChefMenuLocalDataSource>(() =>
      _i46.ChefMenuLocalDataSourceImp(
          sharedPreferences: get<_i21.SharedPreferences>()));
  gh.lazySingleton<_i47.ChefMenuRemoteDataSource>(
      () => _i48.ChefMenuRemoteDataSourceImp(dio: get<_i4.Dio>()));
  gh.lazySingleton<_i49.ChefMenuRepository>(() => _i50.ChefMenuRepositoryImp(
      get<_i47.ChefMenuRemoteDataSource>(),
      get<_i45.ChefMenuLocalDataSource>()));
  gh.lazySingleton<_i51.ChefsLocalDataSource>(() =>
      _i52.ShowMenuLocalDataSourceImp(
          sharedPreferences: get<_i21.SharedPreferences>()));
  gh.lazySingleton<_i53.ChefsRemoteDataSource>(
      () => _i54.ShowMenuRemoteDataSourceImp(dio: get<_i4.Dio>()));
  gh.lazySingleton<_i55.ChefsRepository>(() => _i56.ChefsRepositoryImp(
      get<_i53.ChefsRemoteDataSource>(), get<_i51.ChefsLocalDataSource>()));
  gh.lazySingleton<_i57.CurrentSubscriptionsLocalDataSource>(() =>
      _i58.CurrentSubscriptionsLocalDataSourceImp(
          sharedPreferences: get<_i21.SharedPreferences>()));
  gh.lazySingleton<_i59.CurrentSubscriptionsRemoteDataSource>(
      () => _i60.CurrentSubscriptionsRemoteDataSourceImp(dio: get<_i4.Dio>()));
  gh.lazySingleton<_i61.CurrentSubscriptionsRepository>(() =>
      _i62.CurrentSubscriptionsRepositoryImp(
          get<_i57.CurrentSubscriptionsLocalDataSource>(),
          get<_i59.CurrentSubscriptionsRemoteDataSource>(),
          baseLocalDataSource: get<_i36.BaseLocalDataSource>(),
          networkInfo: get<_i12.NetworkInfo>()));
  gh.lazySingleton<_i63.DeleteCartItemUseCase>(
      () => _i63.DeleteCartItemUseCase(get<_i42.CartRepository>()));
  gh.lazySingleton<_i64.DeleteCartUseCase>(
      () => _i64.DeleteCartUseCase(get<_i42.CartRepository>()));
  ...
  gh.lazySingleton<_i69.GetCartItemsUseCase>(
      () => _i69.GetCartItemsUseCase(get<_i42.CartRepository>()));
  gh.lazySingleton<_i70.GetChefCategoriesUseCase>(
      () => _i70.GetChefCategoriesUseCase(get<_i49.ChefMenuRepository>()));
  gh.lazySingleton<_i71.GetChefCategoryMealsUseCase>(
      () => _i71.GetChefCategoryMealsUseCase(get<_i49.ChefMenuRepository>()));
  gh.lazySingleton<_i72.GetChefInfoUseCase>(
      () => _i72.GetChefInfoUseCase(get<_i49.ChefMenuRepository>()));
  gh.lazySingleton<_i73.GetChefSubscriptionsUseCase>(
      () => _i73.GetChefSubscriptionsUseCase(get<_i49.ChefMenuRepository>()));
  gh.lazySingleton<_i74.GetCurrentSubscriptionsUseCase>(() =>
      _i74.GetCurrentSubscriptionsUseCase(
          get<_i61.CurrentSubscriptionsRepository>()));
  ...
  gh.lazySingleton<_i76.GetMostRecentChefsUseCase>(
      () => _i76.GetMostRecentChefsUseCase(get<_i55.ChefsRepository>()));
  gh.lazySingleton<_i77.GetNearestChefsUseCase>(
      () => _i77.GetNearestChefsUseCase(get<_i55.ChefsRepository>()));
  ...
  gh.lazySingleton<_i79.GetTopOrdersChefsUseCase>(
      () => _i79.GetTopOrdersChefsUseCase(get<_i55.ChefsRepository>()));
  gh.lazySingleton<_i80.GetTopRatedChefsUseCase>(
      () => _i80.GetTopRatedChefsUseCase(get<_i55.ChefsRepository>()));
  ...
  gh.lazySingleton<_i89.OrderCartUseCase>(
      () => _i89.OrderCartUseCase(get<_i42.CartRepository>()));
  ...
  gh.lazySingleton<_i100.ProfileRepository>(() => _i101.ProfileRepositoryImp(
      get<_i98.ProfileLocalDataSource>(), get<_i17.ProfileRemoteDataSource>(),
      baseLocalDataSource: get<_i36.BaseLocalDataSource>(),
      networkInfo: get<_i12.NetworkInfo>()));
  ...
  gh.lazySingleton<_i105.RequestRegisterUseCase>(
      () => _i105.RequestRegisterUseCase(get<_i34.AuthRepository>()));
  ...
  gh.lazySingleton<_i108.SearchRepo>(() => _i109.SearchRepoImp(
      get<_i106.SearchLocalDataSource>(), get<_i19.SearchRemoteDataSource>()));
  ...
  gh.lazySingleton<_i111.SendCodeUseCase>(
      () => _i111.SendCodeUseCase(get<_i34.AuthRepository>()));
  ...
  gh.lazySingleton<_i114.SubscriptionRepository>(() =>
      _i115.SubscriptionRepositoryImp(get<_i26.SubscriptionLocalDataSource>(),
          get<_i28.SubscriptionRemoteDataSource>(),
          baseLocalDataSource: get<_i36.BaseLocalDataSource>(),
          networkInfo: get<_i12.NetworkInfo>()));
  gh.lazySingleton<_i116.UpdateCartItemQuantityUseCase>(
      () => _i116.UpdateCartItemQuantityUseCase(get<_i42.CartRepository>()));
  ...
  gh.factory<_i119.AuthBloc>(() => _i119.AuthBloc(get<_i44.CheckCodeUseCase>(),
  ...
  gh.lazySingleton<_i121.CartBloc>(() => _i121.CartBloc(
      ...
      get<_i63.DeleteCartItemUseCase>(),
      get<_i116.UpdateCartItemQuantityUseCase>(),
      get<_i64.DeleteCartUseCase>()));
  ...
  gh.lazySingleton<_i137.GetProfileInfoUseCase>(
      () => _i137.GetProfileInfoUseCase(get<_i100.ProfileRepository>()));
  gh.lazySingleton<_i138.GetRecentMealsUseCase>(
      () => _i138.GetRecentMealsUseCase(get<_i87.MealsRepository>()));
  gh.lazySingleton<_i139.GetSubscriptionMealsUseCase>(() =>
      _i139.GetSubscriptionMealsUseCase(get<_i114.SubscriptionRepository>()));
  gh.lazySingleton<_i140.GetSubscriptionUseCase>(
      () => _i140.GetSubscriptionUseCase(get<_i114.SubscriptionRepository>()));
  gh.lazySingleton<_i141.GetTopOrderedMealsUseCase>(
      () => _i141.GetTopOrderedMealsUseCase(get<_i87.MealsRepository>()));
  gh.lazySingleton<_i142.GetTopRatedMealsUseCase>(
      () => _i142.GetTopRatedMealsUseCase(get<_i87.MealsRepository>()));
  gh.lazySingleton<_i143.GetTopSubscriptionsUseCase>(
      () => _i143.GetTopSubscriptionsUseCase(get<_i87.MealsRepository>()));
  gh.lazySingleton<_i144.LogoutUseCase>(
      () => _i144.LogoutUseCase(get<_i100.ProfileRepository>()));
  gh.factory<_i145.MealBloc>(() => _i145.MealBloc(
  ...
  gh.factory<_i146.MealsBloc>(() => _i146.MealsBloc(
      get<_i134.GetOfferedMealsUseCase>(),
      get<_i138.GetRecentMealsUseCase>(),
      get<_i143.GetTopSubscriptionsUseCase>(),
      get<_i141.GetTopOrderedMealsUseCase>(),
      get<_i142.GetTopRatedMealsUseCase>(),
      get<_i129.GetAllOfferedMealsUseCase>(),
      get<_i130.GetAllSubscriptionsUseCase>()));
  gh.factory<_i147.OrderBloc>(() => _i147.OrderBloc(
      get<_i120.CancelOrderUseCase>(),
      get<_i135.GetOrderUseCase>(),
      get<_i104.ReportOrderUseCase>(),
      get<_i102.RateOrderUseCase>()));
  gh.factory<_i148.OrdersBloc>(() => _i148.OrdersBloc(
  ...
  gh.lazySingleton<_i151.SearchMealsUseCase>(
      () => _i151.SearchMealsUseCase(get<_i108.SearchRepo>()));
  gh.factory<_i152.SplashBloc>(
      () => _i152.SplashBloc(get<_i123.CheckAuthUseCase>()));
  gh.lazySingleton<_i153.SubscribeUseCase>(
      () => _i153.SubscribeUseCase(get<_i114.SubscriptionRepository>()));
  gh.factory<_i154.SubscriptionBloc>(() => _i154.SubscriptionBloc(
      get<_i140.GetSubscriptionUseCase>(),
      get<_i139.GetSubscriptionMealsUseCase>(),
      get<_i153.SubscribeUseCase>()));
  gh.factory<_i155.SearchBloc>(() => _i155.SearchBloc(
      get<_i151.SearchMealsUseCase>(),
      get<_i110.SearchSubscriptionsUseCase>(),
      get<_i150.SearchChefsUseCase>()));
  return get;
}
