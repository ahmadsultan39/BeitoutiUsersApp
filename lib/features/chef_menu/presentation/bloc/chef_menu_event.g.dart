...
class _$GetChefCategoriesEvent extends GetChefCategoriesEvent {
  ...
  _$GetChefCategoriesEvent._({required this.id}) : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'GetChefCategoriesEvent', 'id');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetChefCategoriesEvent')
          ..add('id', id))
        .toString();
  }
}
    ...
    final _$result = _$v ??
        new _$GetChefCategoriesEvent._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'GetChefCategoriesEvent', 'id'));
    replace(_$result);
    return _$result;
  }
}
...
class _$GetChefCategoryMealsEvent extends GetChefCategoryMealsEvent {
  ...
  _$GetChefCategoryMealsEvent._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        chefId, r'GetChefCategoryMealsEvent', 'chefId');
    BuiltValueNullFieldError.checkNotNull(
        categoryId, r'GetChefCategoryMealsEvent', 'categoryId');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetChefCategoryMealsEvent')
          ..add('chefId', chefId)
...
class _$GetChefInfoEvent extends GetChefInfoEvent {
  ...
  _$GetChefInfoEvent._({required this.id}) : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'GetChefInfoEvent', 'id');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetChefInfoEvent')..add('id', id))
        .toString();
  }
}
...
class _$GetChefSubscriptionsEvent extends GetChefSubscriptionsEvent {
  ...
  _$GetChefSubscriptionsEvent._({required this.id}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        id, r'GetChefSubscriptionsEvent', 'id');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetChefSubscriptionsEvent')
          ..add('id', id))
        .toString();
  }
}
...
class _$GetChefSubscriptionMealsEvent extends GetChefSubscriptionMealsEvent {
  ...
  _$GetChefSubscriptionMealsEvent._({required this.id}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        id, r'GetChefSubscriptionMealsEvent', 'id');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetChefSubscriptionMealsEvent')
          ..add('id', id))
        .toString();
  }
}
