...
class _$SearchState extends SearchState {
  ...
  _$SearchState._(
    ...
    BuiltValueNullFieldError.checkNotNull(message, 'SearchState', 'message');
    BuiltValueNullFieldError.checkNotNull(error, 'SearchState', 'error');
    BuiltValueNullFieldError.checkNotNull(meals, 'SearchState', 'meals');
    BuiltValueNullFieldError.checkNotNull(
        mealsPage, 'SearchState', 'mealsPage');
    BuiltValueNullFieldError.checkNotNull(
        isMealsFinished, 'SearchState', 'isMealsFinished');
    BuiltValueNullFieldError.checkNotNull(
        totalMeals, 'SearchState', 'totalMeals');
    BuiltValueNullFieldError.checkNotNull(
        isMealsLoading, 'SearchState', 'isMealsLoading');
    BuiltValueNullFieldError.checkNotNull(
        subscriptions, 'SearchState', 'subscriptions');
    BuiltValueNullFieldError.checkNotNull(
        subscriptionsPage, 'SearchState', 'subscriptionsPage');
    BuiltValueNullFieldError.checkNotNull(
        isSubscriptionsFinished, 'SearchState', 'isSubscriptionsFinished');
    BuiltValueNullFieldError.checkNotNull(
        totalSubscriptions, 'SearchState', 'totalSubscriptions');
    BuiltValueNullFieldError.checkNotNull(
        isSubscriptionsLoading, 'SearchState', 'isSubscriptionsLoading');
    BuiltValueNullFieldError.checkNotNull(chefs, 'SearchState', 'chefs');
    BuiltValueNullFieldError.checkNotNull(
        chefsPage, 'SearchState', 'chefsPage');
    BuiltValueNullFieldError.checkNotNull(
        isChefsFinished, 'SearchState', 'isChefsFinished');
    BuiltValueNullFieldError.checkNotNull(
        totalChefs, 'SearchState', 'totalChefs');
    BuiltValueNullFieldError.checkNotNull(
        isChefsLoading, 'SearchState', 'isChefsLoading');
  }
      ...
      _$result = _$v ??
          new _$SearchState._(
              ...
              subscriptionsPage: BuiltValueNullFieldError.checkNotNull(
                  subscriptionsPage, 'SearchState', 'subscriptionsPage'),
              isSubscriptionsFinished: BuiltValueNullFieldError.checkNotNull(
                  isSubscriptionsFinished, 'SearchState', 'isSubscriptionsFinished'),
              totalSubscriptions: BuiltValueNullFieldError.checkNotNull(totalSubscriptions, 'SearchState', 'totalSubscriptions'),
              isSubscriptionsLoading: BuiltValueNullFieldError.checkNotNull(isSubscriptionsLoading, 'SearchState', 'isSubscriptionsLoading'),
              chefs: chefs.build(),
              chefsPage: BuiltValueNullFieldError.checkNotNull(chefsPage, 'SearchState', 'chefsPage'),
              isChefsFinished: BuiltValueNullFieldError.checkNotNull(isChefsFinished, 'SearchState', 'isChefsFinished'),
              totalChefs: BuiltValueNullFieldError.checkNotNull(totalChefs, 'SearchState', 'totalChefs'),
              isChefsLoading: BuiltValueNullFieldError.checkNotNull(isChefsLoading, 'SearchState', 'isChefsLoading'));
    } catch (_) {
