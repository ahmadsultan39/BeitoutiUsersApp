...
abstract class SearchRepo {
  Future<Either<Failure,PaginateList<SearchMeal>>> getMeals(String query,int page);
  Future<Either<Failure,PaginateList<SearchSubscription>>> getSubscriptions(String query,int page);
